# Every tunable for the GARCH vine copula study, so no other file holds a magic number.
...
# Marginal chosen by the paper, AR(1) EGARCH(1,1) with normal innovations.
MARGINAL <- list(
  arma_order = c(1, 0),
